...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.4 -->
    <link href="../sellphone_case2/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Font Awesome Icons -->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!-- Ionicons -->
    <link href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
    <link href="../sellphone_case2/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
    <link href="../sellphone_case2/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
  ...
  <style type="text/css">
      ...
      <!-- jQuery 2.2.3 -->
    <script src="../sellphone_case2/js/jquery-3.3.1.js"></script>
